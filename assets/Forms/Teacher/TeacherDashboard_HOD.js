...
const TeacherDashboard_HOD = () => {
  ...
  // Helper component for HOD Dashboard Items
    ...
    <ScrollView contentContainerStyle={ss.main}>
      ...
      <View style={ss.profileCard}>
        <View style={ss.profileInfo}>
          ...
          <Text style={ss.pText}>Name: <Text style={ss.bold}>{teacherData?.Name || "Dr Munir Ahmed"}</Text></Text>
          <Text style={ss.pText}>Designation: <Text style={ss.bold}>{teacherData?.Designation || "HOD"}</Text></Text>
