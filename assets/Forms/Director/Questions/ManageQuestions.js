     ...
     return (
        <ScrollView contentContainerStyle={ss.main}>
          ...
          <View style={ss.mView}>
            ...
            <View style={ss.mView}>
                <Text style={ss.txt}>Director Dashboard</Text>
            </View>
            <View style={ss.mainView}>
                <TouchableOpacity style={ss.Btn}>
                <Text style={ss.btnText}>View Teacher Perfomance</Text>
                </TouchableOpacity>
                <TouchableOpacity style={ss.Btn}>
                <Text style={ss.btnText}>Manage Questions</Text>
                </TouchableOpacity>
                <TouchableOpacity style={ss.Btn}>
                <Text style={ss.btnText}>Gender Analytics</Text>
                </TouchableOpacity>
            </View>
