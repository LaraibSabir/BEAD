...
const ManagerStudent = () => {
  return (
    <ScrollView contentContainerStyle={ss.main}>
      ...
      <View style={ss.mCard}>
        <Text style={ss.mTitle}>Manage Faculty</Text>
        ...
        <TouchableOpacity style={ss.uploadBtn}>
          <Text style={ss.uploadText}>⬆ Browse Files</Text>
        </TouchableOpacity>

        <View style={ss.thead}>
          <Text style={ss.th}>Name</Text>
          <Text style={ss.th}>Edit / Delete</Text>
        </View>

        {renderRow("Dr Sadaf Gull")}
        {renderRow("Ms Ayesha Ahmed")}
        {renderRow("Mr Umer Farooq")}
      </View>
